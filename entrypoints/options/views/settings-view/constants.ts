...
export const SETTINGS_SEARCH_INDEX: SettingSearchItem[] = [
	...
	},
	{
		...
		category: 'integrations',
		section: 'Servicios externos',
		label: 'football-data.org API',
		description: 'Configura la API key gratuita para consultar partidos de fútbol, La Liga y la Champions.',
		keywords: ['futbol', 'liga', 'champions', 'partidos', 'calendario', 'api key', 'deportes'],
		settingKeys: ['footballDataApiKey'],
		isEnabled: settings => Boolean(settings.footballDataApiKey),
	},
	{
		id: 'new-homepage',
		category: 'features',
	...
	{
		id: 'football-calendar',
		category: 'features',
		section: 'Deportes',
		label: 'Calendario de fútbol',
		description: 'Muestra resultados recientes y próximos partidos de La Liga y la Champions en el subforo Deportes.',
		keywords: ['futbol', 'liga', 'champions', 'partidos', 'calendario', 'api key', 'deportes'],
		settingKeys: ['footballCalendarEnabled'],
		requiresReload: true,
		isEnabled: settings => settings.footballCalendarEnabled,
	},
	{
		id: 'thread-clipper',
		category: 'features',
	...
	},
	{
		...
		description: 'El scroll infinito se activa automáticamente al entrar en un hilo si Auto Live no está activo.',
	...
	},
	{
		...
		description: 'Activa el Live de MV Premium al entrar en hilos normales y desactiva el auto scroll infinito.',
		keywords: ['live', 'auto', 'automatico', 'hilos', 'tiempo real'],
		settingKeys: ['autoLiveThreadEnabled'],
		requiresReload: true,
		isEnabled: settings => settings.autoLiveThreadEnabled,
	},
	{
		id: 'gallery-button',
		category: 'navigation',
	...
	},
	{
		...
		description: 'Registra títulos, URLs y contexto para el calendario legacy. Puede no ser exacto y está desactivado por defecto.',
		keywords: ['actividad', 'heatmap', 'legacy', 'estadisticas', 'posts'],
