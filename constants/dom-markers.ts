...
export const DOM_MARKERS = {
	...
	CLASSES: {
		...
		RELATED_THREADS_TOGGLE: 'mvp-related-threads-toggle',
		RELATED_THREADS_LABEL: 'mvp-related-threads-label',
		RELATED_THREADS_CHEVRON: 'mvp-related-threads-chevron',
	...
	IDS: {
		...
		WORK_MODE_STYLES: 'mvp-work-mode-styles',
		...
		RELATED_THREADS_CONTENT: 'mvp-related-threads-content',
		RELATED_THREADS_STYLES: 'mvp-related-threads-styles',
